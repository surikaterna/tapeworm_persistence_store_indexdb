...
IdbPartition.prototype.open = function() {
	var self = this;
	var request = this._idb.open('tapeworm_'+this._partitionId, 2);
...
//			if(event.oldVersion < 2) {
				self._truncatedCommits = db.createObjectStore('truncated', {keyPath: 'id', unique: true});
				self._persistedCommits.createIndex('streamId', 'streamId', {unique:false});
//			}
...
IdbPartition.prototype.truncateStreamFrom = function(streamId, commitSequence, callback) {
	var self = this;
